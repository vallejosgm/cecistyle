                    ...
                    <tr>
                        <td align="left" bgcolor="#ffffff" style="padding: 24px; font-size: 16px; line-height: 24px;">
                            @php
                                ...
                                $messageEmail = '';
                                $messageEmail .= '<p style="margin: 0;">Cecilia, after your client has received their confirmation email, we send you the details of the appointment:<br><br>';
                                $messageEmail .= '<ul>';
                                $messageEmail .= '<li>Name: ' . $_POST['fullname'] . '</li>';
                                $messageEmail .= '<li>Email: ' . $_POST['email'] . '</li>';
                                $messageEmail .= '<li>Day: ' . $dayApp . '</li>';
                                $messageEmail .= '<li>Time: ' . $_POST['hHidden'] . '</li>';
                                $messageEmail .= '<li>Service: ' . $_POST['nsHidden'] . '</li>';
                                $messageEmail .= '<li>Phone: ' . $_POST['phone'] . '</li>';
                                $messageEmail .= '<li>Message: ' . $_POST['comments'] . '</li>';
                                $messageEmail .= '</ul></p><br>';
                                $messageEmail .= '<p>Do not forget to update your agenda with this new appointment.</p>';
                                echo $messageEmail;
                            @endphp
                        </td>
                    </tr>
